...
const ImageCropOverlay = () => {
  ...
  const [accumulatedPan, setAccumluatedPan] = (0, _recoil.useRecoilState)(_Store.accumulatedPanState); // Editor context
  ...
  horizontalSections.map(hsection => {
    return /*#__PURE__*/React.createElement(_reactNative.View, {
      ...
      key == "topleft" || key == "topright" || key == "bottomleft" || key == "bottomright" ? /*#__PURE__*/React.createElement(_reactNative.View, {
