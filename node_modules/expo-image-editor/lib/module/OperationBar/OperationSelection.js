...
export function OperationSelection() {
  ...
  filteredOperations[selectedOperationGroup].map((item, index) => /*#__PURE__*/React.createElement(View, {
  ...
  })))), !isTransformOnly && !isAdjustmentOnly ? /*#__PURE__*/React.createElement(View, {
